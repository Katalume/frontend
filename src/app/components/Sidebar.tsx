  ...
  return (
    <>
      <aside
        ...
        className={`fixed left-0 top-0 z-20 flex h-screen w-60 flex-col border-r border-zinc-200/70 bg-white/70 backdrop-blur-xl transition-transform duration-300 dark:border-white/[0.06] dark:bg-[#0a091e]/90 ${
